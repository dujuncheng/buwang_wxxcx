<template>
	<div>
		<div class="login-container">
			...
			<input type="password" v-if="state === 'register'" v-model="rePassword" placeholder="确认密码" class="password-input">
